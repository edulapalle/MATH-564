...
As we can see from the graphs above, only Smoker variable has significant effect on charges. We can see non-smokers with less charges than smokers. So, we will focus on Smoker variable than bmi and region.
```{r}
